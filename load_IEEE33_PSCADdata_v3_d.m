function data =  load_IEEE33_PSCADdata_v3_d(filename)
...
%    <channel index="51" id="306000100:0" name="ev_pi_1" label="" dim="1" unit="V" min="-1" max="1" />
%     <channel index="52" id="1902623113:0" name="qrif_pi_1" label="" dim="1" unit="kVAr" min="-25" max="25" />
...
data.ev_pi_1 = sim_data_06(:,3);
data.qrif_pi_1 = sim_data_06(:,4);