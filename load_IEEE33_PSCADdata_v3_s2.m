function data =  load_IEEE33_PSCADdata_v3_s2(filename)
...
%     <channel index="51" id="306000100:0" name="ev_pi_s_3" label="" dim="1" unit="V" min="-1" max="1" />
%     <channel index="52" id="15032339:0" name="ev_pi_3" label="" dim="1" unit="V" min="-1" max="1" />
%     <channel index="53" id="1716419727:0" name="qrif_pi_s_3" label="" dim="1" unit="kVAr" min="-25" max="25" />
%     <channel index="54" id="1306800170:0" name="qrif_pi_3" label="" dim="1" unit="kVAr" min="-25" max="25" />
%     <channel index="55" id="1902623113:0" name="qrif_pi_t_3" label="" dim="1" unit="kVAr" min="-25" max="25" />
%     <channel index="56" id="849100941:0" name="ev_pi_s_1" label="" dim="1" unit="V" min="-1" max="1" />
%     <channel index="57" id="1728391412:0" name="ev_pi_1" label="" dim="1" unit="V" min="-1" max="1" />
%     <channel index="58" id="1549494882:0" name="qrif_pi_s_1" label="" dim="1" unit="kVAr" min="-25" max="25" />
%     <channel index="59" id="1666093388:0" name="qrif_pi_1" label="" dim="1" unit="kVAr" min="-25" max="25" />
% 07
%     <channel index="60" id="1528128042:0" name="qrif_pi_t_1" label="" dim="1" unit="kVAr" min="-25" max="25" />
%     <channel index="61" id="1863056105:0" name="ev_pi_s_2" label="" dim="1" unit="V" min="-1" max="1" />
%     <channel index="62" id="1600628031:0" name="ev_pi_2" label="" dim="1" unit="V" min="-1" max="1" />
%     <channel index="63" id="1573201729:0" name="qrif_pi_s_2" label="" dim="1" unit="kVAr" min="-25" max="25" />
%     <channel index="64" id="1470109352:0" name="qrif_pi_2" label="" dim="1" unit="kVAr" min="-25" max="25" />
%     <channel index="65" id="2022842993:0" name="qrif_pi_t_2" label="" dim="1" unit="kVAr" min="-25" max="25" />
%     <channel index="66" id="303919907:0" name="ev_pi_s_5" label="" dim="1" unit="V" min="-1" max="1" />
%     <channel index="67" id="1357728057:0" name="ev_pi_5" label="" dim="1" unit="V" min="-1" max="1" />
%     <channel index="68" id="656203098:0" name="qrif_pi_s_5" label="" dim="1" unit="kVAr" min="-25" max="25" />
%     <channel index="69" id="268398280:0" name="qrif_pi_5" label="" dim="1" unit="kVAr" min="-25" max="25" />
% 08
%     <channel index="70" id="255967290:0" name="qrif_pi_t_5" label="" dim="1" unit="kVAr" min="-25" max="25" />
%     <channel index="71" id="306000100:0" name="ev_pi_s_6" label="" dim="1" unit="V" min="-1" max="1" />
%     <channel index="72" id="15032339:0" name="ev_pi_6" label="" dim="1" unit="V" min="-1" max="1" />
%     <channel index="73" id="1716419727:0" name="qrif_pi_s_6" label="" dim="1" unit="kVAr" min="-25" max="25" />
%     <channel index="74" id="1306800170:0" name="qrif_pi_6" label="" dim="1" unit="kVAr" min="-25" max="25" />
%     <channel index="75" id="1902623113:0" name="qrif_pi_t_6" label="" dim="1" unit="kVAr" min="-25" max="25" />
%     <channel index="76" id="849100941:0" name="ev_pi_s_4" label="" dim="1" unit="V" min="-1" max="1" />
%     <channel index="77" id="1728391412:0" name="ev_pi_4" label="" dim="1" unit="V" min="-1" max="1" />
%     <channel index="78" id="1549494882:0" name="qrif_pi_s_4" label="" dim="1" unit="kVAr" min="-25" max="25" />
%     <channel index="79" id="1666093388:0" name="qrif_pi_4" label="" dim="1" unit="kVAr" min="-25" max="25" />
% 09
%     <channel index="80" id="1528128042:0" name="qrif_pi_t_4" label="" dim="1" unit="kVAr" min="-25" max="25" />
%    
...
% load -ascii _v2_mv1_07.out
sim_data_07 =  load(strcat(filename,'_07.out'),'-ascii');

% load -ascii _v2_mv1_08.out
sim_data_08 =  load(strcat(filename,'_08.out'),'-ascii');

% load -ascii _v2_mv1_09.out
sim_data_09 =  load(strcat(filename,'_09.out'),'-ascii');
...
data.ev_pi_s_3    = sim_data_06(:,3 );
data.ev_pi_3      = sim_data_06(:,4 );
data.qrif_pi_s_3  = sim_data_06(:,5 );
data.qrif_pi_3    = sim_data_06(:,6 );
data.qrif_pi_t_3  = sim_data_06(:,7 );
data.ev_pi_s_1    = sim_data_06(:,8 );
data.ev_pi_1      = sim_data_06(:,9 );
data.qrif_pi_s_1  = sim_data_06(:,10);
data.qrif_pi_1    = sim_data_06(:,11);
                                     
data.qrif_pi_t_1  = sim_data_07(:,2 );
data.ev_pi_s_2    = sim_data_07(:,3 );
data.ev_pi_2      = sim_data_07(:,4 );
data.qrif_pi_s_2  = sim_data_07(:,5 );
data.qrif_pi_2    = sim_data_07(:,6 );
data.qrif_pi_t_2  = sim_data_07(:,7 );
data.ev_pi_s_5    = sim_data_07(:,8 );
data.ev_pi_5      = sim_data_07(:,9 );
data.qrif_pi_s_5  = sim_data_07(:,10);
data.qrif_pi_5    = sim_data_07(:,11);
                                     
data.qrif_pi_t_5  = sim_data_08(:,2) ;
data.ev_pi_s_6    = sim_data_08(:,3 );
data.ev_pi_6      = sim_data_08(:,4 );
data.qrif_pi_s_6  = sim_data_08(:,5 );
data.qrif_pi_6    = sim_data_08(:,6 );
data.qrif_pi_t_6  = sim_data_08(:,7 );
data.ev_pi_s_4    = sim_data_08(:,8 );
data.ev_pi_4      = sim_data_08(:,9 );
data.qrif_pi_s_4  = sim_data_08(:,10);
data.qrif_pi_4    = sim_data_08(:,11);
                                     
data.qrif_pi_t_4  = sim_data_09(:,2 );
