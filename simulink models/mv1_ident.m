...
kp = (VSimMat_d(end,14) - VSimMat_d(10,14))/(Q_dgf(1) - Q_dg0(1));
kpn = kp/dk_n;
Tp = 0.05;
...
%g11 = K / (tau*s + 1) // dQdg1_ref = 100/500 = 0.2 
kp = (VSimMat_d(end,18) - VSimMat_d(10,18))/(Q_dgf(1) - Q_dg0(1));
kpn = kp/dk_n;
Tp = 0.05;
