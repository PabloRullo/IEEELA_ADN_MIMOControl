...
%g11 = K / (tau*s + 1) // dQdg6_ref = 100/500 = 0.2 
kp = (VSimMat_d(end,14) - VSimMat_d(10,14))/(Q_dgf(6) - Q_dg0(6));
kpn = kp/dk_n;
Tp = 0.05;
...
sys = tf(num,den);
g16 = sys;
v_iden = 0.2*step(sys,tt);% dQdg6_ref = 100/500 
...
%g11 = K / (tau*s + 1) // dQdg6_ref = 100/500 = 0.2 
kp = (VSimMat_d(end,18) - VSimMat_d(10,18))/(Q_dgf(6) - Q_dg0(6));
kpn = kp/dk_n;
Tp = 0.05;
...
%g11 = K / (tau*s + 1) // dQdg6_ref = 100/500 = 0.2 
kp = (VSimMat_d(end,21) - VSimMat_d(10,21))/(Q_dgf(6) - Q_dg0(6));
kpn = kp/dk_n;
Tp = 0.05;
...
%g11 = K / (tau*s + 1) // dQdg6_ref = 100/500 = 0.2 
kp = (VSimMat_d(end,25) - VSimMat_d(10,25))/(Q_dgf(6) - Q_dg0(6));
kpn = kp/dk_n;
Tp = 0.05;
...
%g11 = K / (tau*s + 1) // dQdg6_ref = 100/500 = 0.2 
kp = (VSimMat_d(end,30) - VSimMat_d(10,30))/(Q_dgf(6) - Q_dg0(6));
kpn = kp/dk_n;
Tp = 0.05;
...
%g11 = K / (tau*s + 1) // dQdg6_ref = 100/500 = 0.2 
kp = (VSimMat_d(end,33) - VSimMat_d(10,33))/(Q_dgf(6) - Q_dg0(6));
kpn = kp/dk_n;
Tp = 0.05;
