...
v_17_s2 =  data_s2.v_17(ni:end);
v_17_s3 =  data_s3.v_17(ni:end);

mv_2_d = data_d.Q_dg2(ni:end);
mv_2_s = data_s.Q_dg2(ni:end);

mv_2_s2 = data_s2.Q_dg2(ni:end);
mv_2_s3 = data_s3.Q_dg2(ni:end);
% node voltage
% figure
...
v_20_s2 =  data_s2.v_20(ni:end);
v_20_s3 =  data_s3.v_20(ni:end);

mv_3_d = data_d.Q_dg3(ni:end);
mv_3_s = data_s.Q_dg3(ni:end);

mv_3_s2 = data_s2.Q_dg3(ni:end);
mv_3_s3 = data_s3.Q_dg3(ni:end);
% node voltage
% figure
...
v_24_s2 =  data_s2.v_24(ni:end);
v_24_s3 =  data_s3.v_24(ni:end);

mv_4_d = data_d.Q_dg4(ni:end);
mv_4_s = data_s.Q_dg4(ni:end);

mv_4_s2 = data_s2.Q_dg4(ni:end);
mv_4_s3 = data_s3.Q_dg4(ni:end);
% node voltage
% figure
...
v_29_s2 =  data_s2.v_29(ni:end);
v_29_s3 =  data_s3.v_29(ni:end);

mv_5_d = data_d.Q_dg5(ni:end);
mv_5_s = data_s.Q_dg5(ni:end);

mv_5_s2 = data_s2.Q_dg5(ni:end);
mv_5_s3 = data_s3.Q_dg5(ni:end);
...
v_32_s2 =  data_s2.v_32(ni:end);
v_32_s3 =  data_s3.v_32(ni:end);

mv_6_d = data_d.Q_dg6(ni:end);
mv_6_s = data_s.Q_dg6(ni:end);

mv_6_s2 = data_s2.Q_dg6(ni:end);
mv_6_s3 = data_s3.Q_dg6(ni:end);
...
figure
set(gcf, 'Position', [0 0 800 1050]);
subplot(2,3,1),plot(tt,v_13_d,tt,v_13_s,tt,v_13_s2,tt,v_13_s3),grid on,xlabel('time (s)'),ylabel('v_{13} (pu)')
legend('\Gamma_{dlo}','\Gamma_{ss1}','\Gamma_{ss2}','\Gamma_{ss3}')
subplot(2,3,2),plot(tt,v_17_d,tt,v_17_s,tt,v_17_s2,tt,v_17_s3),grid on, xlabel('time (s)'),ylabel('v_{17} (pu)')
subplot(2,3,3),plot(tt,v_20_d,tt,v_20_s,tt,v_20_s2,tt,v_20_s3),grid on, xlabel('time (s)'),ylabel('v_{20} (pu)')
subplot(2,3,4),plot(tt,v_24_d,tt,v_24_s,tt,v_24_s2,tt,v_24_s3),grid on, xlabel('time (s)'),ylabel('v_{24} (pu)')
subplot(2,3,5),plot(tt,v_29_d,tt,v_29_s,tt,v_29_s2,tt,v_29_s3),grid on, xlabel('time (s)'),ylabel('v_{29} (pu)')
subplot(2,3,6),plot(tt,v_32_d,tt,v_32_s,tt,v_32_s2,tt,v_32_s3),grid on, xlabel('time (s)'),ylabel('v_{32} (pu)')

% 
figure
set(gcf, 'Position', [900 0 800 1050]);
subplot(2,3,1),plot(tt,mv_1_d,tt,mv_1_s,tt,mv_1_s2,tt,mv_1_s3),grid on, xlabel('time (s)'),ylabel('Qdg_1 (kVAr)')
legend('\Gamma_{dlo}','\Gamma_{ss1}','\Gamma_{ss2}','\Gamma_{ss3}')                                                   
subplot(2,3,2),plot(tt,mv_2_d,tt,mv_2_s,tt,mv_2_s2,tt,mv_2_s3),grid on, xlabel('time (s)'),ylabel('Qdg_2 (kVAr)')
subplot(2,3,3),plot(tt,mv_3_d,tt,mv_3_s,tt,mv_3_s2,tt,mv_3_s3),grid on, xlabel('time (s)'),ylabel('Qdg_3 (kVAr)')
subplot(2,3,4),plot(tt,mv_4_d,tt,mv_4_s,tt,mv_4_s2,tt,mv_4_s3),grid on, xlabel('time (s)'),ylabel('Qdg_4 (kVAr)')
subplot(2,3,5),plot(tt,mv_5_d,tt,mv_5_s,tt,mv_5_s2,tt,mv_5_s3),grid on, xlabel('time (s)'),ylabel('Qdg_5 (kVAr)')
subplot(2,3,6),plot(tt,mv_6_d,tt,mv_6_s,tt,mv_6_s2,tt,mv_6_s3),grid on, xlabel('time (s)'),ylabel('Qdg_6 (kVAr)')
...
Eu_mv1_ss2 = sum(((mv_1_s2-mv_1_s2(1)*ones(ll,1))./mv_max).^2);
Eu_mv1_ss3 = sum(((mv_1_s3-mv_1_s3(1)*ones(ll,1))./mv_max).^2);

%mv2
Eu_mv2_sd =  sum(((mv_2_d -mv_2_d(1)*ones(ll,1))./mv_max).^2);
Eu_mv2_ss1 = sum(((mv_2_s -mv_2_s(1)*ones(ll,1))./mv_max).^2);
Eu_mv2_ss2 = sum(((mv_2_s2-mv_2_s2(1)*ones(ll,1))./mv_max).^2);
Eu_mv2_ss3 = sum(((mv_2_s3-mv_2_s3(1)*ones(ll,1))./mv_max).^2);

%mv3
Eu_mv3_sd =  sum(((mv_3_d -mv_3_d(1)*ones(ll,1))./mv_max).^2);
Eu_mv3_ss1 = sum(((mv_3_s -mv_3_s(1)*ones(ll,1))./mv_max).^2);
Eu_mv3_ss2 = sum(((mv_3_s2-mv_3_s2(1)*ones(ll,1))./mv_max).^2);
Eu_mv3_ss3 = sum(((mv_3_s3-mv_3_s3(1)*ones(ll,1))./mv_max).^2);

%mv4
Eu_mv4_sd =  sum(((mv_4_d -mv_4_d(1)*ones(ll,1))./mv_max).^2);
Eu_mv4_ss1 = sum(((mv_4_s -mv_4_s(1)*ones(ll,1))./mv_max).^2);
Eu_mv4_ss2 = sum(((mv_4_s2-mv_4_s2(1)*ones(ll,1))./mv_max).^2);
Eu_mv4_ss3 = sum(((mv_4_s3-mv_4_s3(1)*ones(ll,1))./mv_max).^2);

%mv5
Eu_mv5_sd =  sum(((mv_5_d -mv_5_d(1)*ones(ll,1))./mv_max).^2);
Eu_mv5_ss1 = sum(((mv_5_s -mv_5_s(1)*ones(ll,1))./mv_max).^2);
Eu_mv5_ss2 = sum(((mv_5_s2-mv_5_s2(1)*ones(ll,1))./mv_max).^2);
Eu_mv5_ss3 = sum(((mv_5_s3-mv_5_s3(1)*ones(ll,1))./mv_max).^2);

%mv6
Eu_mv6_sd =  sum(((mv_6_d -mv_6_d(1)*ones(ll,1))./mv_max).^2);
Eu_mv6_ss1 = sum(((mv_6_s -mv_6_s(1)*ones(ll,1))./mv_max).^2);
Eu_mv6_ss2 = sum(((mv_6_s2-mv_6_s2(1)*ones(ll,1))./mv_max).^2);
Eu_mv6_ss3 = sum(((mv_6_s3-mv_6_s3(1)*ones(ll,1))./mv_max).^2);
